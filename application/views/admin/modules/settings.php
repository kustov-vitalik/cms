...
/* @var $module Model_Module */
?>
<form method="post" action="/admin/modules/settings/<?= $module->pk() ?>">

    <fieldset>
        <legend><?= $module->getConfig()->getTitle() ?></legend>
        <p><?= $module->getConfig()->getDescription() ?></p>

        <?= Form::checkbox('enable', 'on', $module->getConfig()->isEnable()); ?>
